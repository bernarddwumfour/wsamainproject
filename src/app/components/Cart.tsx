...
const Cart = () => {
  ...
  const generateOrderDetails = (cart: product[]): OrderDetails[] => {
    return cart.map((item, index) => ({
      orderDetailsID: 9, // In a real application, this would be generated by the backend
      orderID:11, // This will be set by the backend
      listingID: item.id,
      quantity: 1,
      price: item.price,
      total: item.price,
  ...
  const [order, setOrder] = useState<Order>({
    orderID: 8, // This should be generated by your backend
  ...
  const [orders, setOrders] = useState<Order>({
    orderID: 11, // This should be generated by your backend
    userID: 123, // Replace with actual user ID
    orderPlaced: new Date().toISOString(),
    customerID: 456, // Replace with actual customer ID
    isOrderFulfilled: false,
    status: 'Pending',
    totalAmount: totalAmount, // Replace with actual total amount
